...
Fragment bundles attach to this host and provide `Weaver` implementations registered in `META-INF/services/org.eclipse.osgi.technology.incubator.opentelemetry.weaving.Weaver`.
