package org.eclipse.osgi.technology.incubator.opentelemetry.weaver.servlet;
...
public class ServletWeaver implements Weaver {
    ...
    public void weave(WovenClass wovenClass, OpenTelemetryProxy telemetry) {
        ...
        // Use COMPUTE_FRAMES with safe getCommonSuperClass to avoid classloader
        // issues in OSGi while still producing valid stack map frames.
        ClassWriter writer = new ClassWriter(reader, ClassWriter.COMPUTE_FRAMES) {
            @Override
            protected String getCommonSuperClass(String type1, String type2) {
                // Safe fallback: Object is always a valid common superclass.
                // This avoids Class.forName calls that fail across OSGi classloaders.
    ...
    private void addDynamicImports(WovenClass wovenClass) {
        ...
        imports.add("org.eclipse.osgi.technology.incubator.opentelemetry.weaver.servlet");
    }
