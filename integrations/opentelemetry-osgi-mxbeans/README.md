...
PID: `org.eclipse.osgi.technology.incubator.opentelemetry.mxbeans`
...
The Docker demo ships with a dedicated **JVM MXBeans Overview** Grafana dashboard:

![JVM MXBeans Overview](../../doc/images/grafana-jvm-mxbeans-overview.png)
...
![JVM GC](../../doc/images/grafana-jvm-gc.png)

### Class Loading

![JVM Class Loading](../../doc/images/grafana-jvm-classloading.png)

### Memory Pools

![JVM Memory Pools](../../doc/images/grafana-jvm-memory-pools.png)

### Buffer Pools

![JVM Buffer Pools](../../doc/images/grafana-jvm-buffer-pools.png)
