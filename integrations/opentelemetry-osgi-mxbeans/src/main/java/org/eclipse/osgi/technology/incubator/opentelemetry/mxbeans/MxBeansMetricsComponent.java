 ...
 */
@Component(immediate = true, configurationPid = "org.eclipse.osgi.technology.incubator.opentelemetry.mxbeans")
public class MxBeansMetricsComponent {
    ...
    private static final String INSTRUMENTATION_SCOPE = "org.eclipse.osgi.technology.incubator.opentelemetry.mxbeans";
