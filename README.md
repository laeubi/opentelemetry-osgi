...
| [`integrations/`](integrations/README.md) | Framework, SCR, Log Service, Health Check, Config Admin, MXBeans, Typed Event, HTTP Whiteboard, and JAX-RS Whiteboard bridges to OpenTelemetry | [Read more →](integrations/README.md) |
...
The demo ships with five pre-built dashboards, Grafana Drilldown apps, and per-instance filtering.
...
For full dashboard documentation with all screenshots, see the [Demo README](demo/opentelemetry-osgi-demo/README.md#dashboards).
